...
export class Video extends Component {
    ...
    modalClose = () => this.setState({ show: false }); // Corrected method name
            ...
            <div className='bottom text-center'></div>
                <Row>
                    <Col lg={6} md={6} sm={12} className='videoText'>
                                    <p className='serviceDescription text-justify'>Hi! I'm Kazi Ariyan. I'm a web developer with a serious love for teaching I am a founder of eLe easy Learning and a passionate Web Developer, Programmer & Instructor. <br /> <br />
